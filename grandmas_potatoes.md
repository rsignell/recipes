...
* Scallions (葱), 4 sprigs, 70g. White and green parts separated, then sliced. The white portion will be used in the beginning of the stir-fry as an aromatic and the green portion is to finish. If you use red onion instead of scallions, coarse dice 20g (to use instead of white scallion) and fine dice 15g (to use instead of green scallion)
